...
client.on("messageCreate", message => {
   ...
   if (message.content.toLowerCase().indexOf("im") !== -1 || message.content.toLowerCase().indexOf("i am") !== -1 || message.content.toLowerCase().indexOf("i\'m") !== -1 || message.content.toLowerCase().indexOf("iam") !== -1 || message.content.toLowerCase().indexOf("i m") !== -1) {
      var newIndex = Math.max(message.content.toLowerCase().indexOf("i am") + 4, message.content.toLowerCase().indexOf("im") + 2, message.content.toLowerCase().indexOf("i\'m") + 3, message.content.toLowerCase().indexOf("iam") + 3, message.content.toLowerCase().indexOf("i m") + 3);
